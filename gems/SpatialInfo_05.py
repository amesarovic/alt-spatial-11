...
class SpatialInfo_05(MacroSpec):
    name: str = "SpatialInfo_05"
    projectName: str = "alt_spatial_11"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class SpatialInfo_05Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("SpatialInfo_05").addElement(
    ...
    def apply(self, props: SpatialInfo_05Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return SpatialInfo_05.SpatialInfo_05Properties(
