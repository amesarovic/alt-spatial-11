...
class Simplify_01(MacroSpec):
    name: str = "Simplify_01"
    projectName: str = "alt_spatial_11"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class Simplify_01Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        return Dialog("Simplify_01").addElement(
    ...
    def apply(self, props: Simplify_01Properties) -> str:
        # Get the table name
