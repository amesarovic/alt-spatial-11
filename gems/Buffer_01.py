...
class Buffer_01(MacroSpec):
    ...
    class Buffer_01Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("Buffer_01").addElement(
    ...
    def apply(self, props: Buffer_01Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return Buffer_01.Buffer_01Properties(
